...
class ReadMangaActivity : BaseComposeActivity(imageBg = false) {
    ...
    private fun handleEffect(effect: MangaReaderEffect) {
        when (effect) {
            ...
            is MangaReaderEffect.OpenSourceLogin -> startActivity<SourceLoginActivity> {
