...
sealed interface RssSourceEditIntent {
    ...
    data object SetVariable : RssSourceEditIntent; data object ShowLog : RssSourceEditIntent; data object Help : RssSourceEditIntent; data object Back : RssSourceEditIntent
}
sealed interface RssSourceEditEffect {
    ...
    data class Variable(val url: String) : RssSourceEditEffect; data object Log : RssSourceEditEffect; data object Help : RssSourceEditEffect; data class Message(val text: String) : RssSourceEditEffect
}
