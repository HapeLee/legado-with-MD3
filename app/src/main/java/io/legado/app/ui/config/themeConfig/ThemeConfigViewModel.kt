    ...
    private fun resetDefaults() {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            appShellSettingsGateway.updateAll(
                listOf(
                    AppShellSettingsUpdate.ThemeMode(defaultShell.themeMode),
                    AppShellSettingsUpdate.FontScale(defaultShell.fontScale),
                    AppShellSettingsUpdate.ComposeEngine(defaultShell.composeEngine),
                    AppShellSettingsUpdate.MainNavigationOrder(defaultShell.mainNavigationOrder),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.ShowHome,
                        defaultShell.showHome
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.ShowDiscovery,
                        defaultShell.showDiscovery
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.ShowRss,
                        defaultShell.showRss
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.ShowStatusBar,
                        defaultShell.showStatusBar
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.SwipeAnimation,
                        defaultShell.swipeAnimation
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.PredictiveBack,
                        defaultShell.predictiveBackEnabled
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.ShowBottomView,
                        defaultShell.showBottomView
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.UseFloatingBottomBar,
                        defaultShell.useFloatingBottomBar
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.UseFloatingBottomBarLiquidGlass,
                        defaultShell.useFloatingBottomBarLiquidGlass
                    ),
                    AppShellSettingsUpdate.BooleanValue(
                        AppShellBooleanSetting.NavExtended,
                        defaultShell.navExtended
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.TabletInterface,
                        defaultShell.tabletInterface
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.LabelVisibilityMode,
                        defaultShell.labelVisibilityMode
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.DefaultHomePage,
                        defaultShell.defaultHomePage
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.NavIconHome,
                        defaultShell.navIconHome
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.NavIconBookshelf,
                        defaultShell.navIconBookshelf
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.NavIconExplore,
                        defaultShell.navIconExplore
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.NavIconRss,
                        defaultShell.navIconRss
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.NavIconMy,
                        defaultShell.navIconMy
                    ),
                    AppShellSettingsUpdate.StringValue(
                        AppShellStringSetting.LauncherIcon,
                        defaultShell.launcherIcon
                    ),
                )
            )
            themeSettingsGateway.updateAll(
                listOf(
                    ThemeSettingsUpdate.AppTheme(defaultTheme.appTheme),
                    ThemeSettingsUpdate.PureBlack(defaultTheme.isPureBlack),
                    ThemeSettingsUpdate.PaletteStyle(defaultTheme.paletteStyle),
                    ThemeSettingsUpdate.MaterialVersion(defaultTheme.materialVersion),
                    ThemeSettingsUpdate.CustomContrast(defaultTheme.customContrast),
                    ThemeSettingsUpdate.DeepPersonalization(defaultTheme.enableDeepPersonalization),
                    ThemeSettingsUpdate.CustomPrimary(defaultTheme.customPrimary),
                    ThemeSettingsUpdate.CustomNightPrimary(defaultTheme.customNightPrimary),
                    ThemeSettingsUpdate.AppFontPath(null),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.Primary,
                        defaultTheme.themeColor
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.Secondary,
                        defaultTheme.secondaryThemeColor
                    ),
                    ThemeSettingsUpdate.CustomColor(
                    ...
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.SecondaryText,
                        defaultTheme.secondaryTextColor
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.Background,
                        defaultTheme.themeBackgroundColor
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.LabelContainer,
                        defaultTheme.labelContainerColor
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.PrimaryNight,
                        defaultTheme.themeColorNight
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.SecondaryNight,
                        defaultTheme.secondaryThemeColorNight
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.PrimaryTextNight,
                        defaultTheme.primaryTextColorNight
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.SecondaryTextNight,
                        defaultTheme.secondaryTextColorNight
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.BackgroundNight,
                        defaultTheme.themeBackgroundColorNight
                    ),
                    ThemeSettingsUpdate.CustomColor(
                        ThemeColorSlot.LabelContainerNight,
                        defaultTheme.labelContainerColorNight
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.UseMiuixMonet,
                        defaultTheme.useMiuixMonet
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.EnableBlur,
                        defaultTheme.enableBlur
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.EnableProgressiveBlur,
                        defaultTheme.enableProgressiveBlur
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.UseFlexibleTopAppBar,
                        defaultTheme.useFlexibleTopAppBar
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.BookInfoFollowCoverColor,
                        defaultTheme.bookInfoFollowCoverColor
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.EnableItemDivider,
                        defaultTheme.enableItemDivider
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.OverrideBaseCardCornerRadius,
                        defaultTheme.overrideBaseCardCornerRadius
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.OverrideBaseCardBorder,
                        defaultTheme.overrideBaseCardBorder
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.DisableSplicedColumnGroupCornerRadius,
                        defaultTheme.disableSplicedColumnGroupCornerRadius
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.EyeProtectionEnabled,
                        defaultTheme.eyeProtectionEnabled
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.EyeProtectionSchedule,
                        defaultTheme.eyeProtectionSchedule
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.ShowRefactorTip,
                        defaultTheme.showRefactorTip
                    ),
                    ThemeSettingsUpdate.BooleanValue(
                        ThemeBooleanSetting.EnableCustomTagColors,
                        defaultTheme.enableCustomTagColors
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.ContainerOpacity,
                        defaultTheme.containerOpacity
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.TopBarOpacity,
                        defaultTheme.topBarOpacity
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.BottomBarOpacity,
                        defaultTheme.bottomBarOpacity
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.TopBarBlurRadius,
                        defaultTheme.topBarBlurRadius
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.BottomBarBlurRadius,
                        defaultTheme.bottomBarBlurRadius
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.TopBarBlurAlpha,
                        defaultTheme.topBarBlurAlpha
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.BottomBarBlurAlpha,
                        defaultTheme.bottomBarBlurAlpha
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.BackgroundImageBlurring,
                        defaultTheme.backgroundImageBlurring
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.BackgroundImageDarkBlurring,
                        defaultTheme.backgroundImageDarkBlurring
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.ItemDividerColor,
                        defaultTheme.itemDividerColor
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.BaseCardBorderColor,
                        defaultTheme.baseCardBorderColor
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.BaseCardBorderColorNight,
                        defaultTheme.baseCardBorderColorNight
                    ),
                    ThemeSettingsUpdate.IntValue(
                        ThemeIntSetting.ColorTemperature,
                        defaultTheme.colorTemperature
                    ),
                    ThemeSettingsUpdate.FloatValue(
                        ThemeFloatSetting.BottomBarLensRadius,
                        defaultTheme.bottomBarLensRadius
                    ),
                    ThemeSettingsUpdate.FloatValue(
                        ThemeFloatSetting.ItemDividerWidth,
                        defaultTheme.itemDividerWidth
                    ),
                    ThemeSettingsUpdate.FloatValue(
                        ThemeFloatSetting.ItemDividerLength,
                        defaultTheme.itemDividerLength
                    ),
                    ThemeSettingsUpdate.FloatValue(
                        ThemeFloatSetting.BaseCardCornerRadius,
                        defaultTheme.baseCardCornerRadius
                    ),
                    ThemeSettingsUpdate.FloatValue(
                        ThemeFloatSetting.BaseCardBorderWidth,
                        defaultTheme.baseCardBorderWidth
                    ),
                    ThemeSettingsUpdate.StringValue(
                        ThemeStringSetting.BookInfoNetworkCoverBackground,
                        defaultTheme.bookInfoNetworkCoverBackground
                    ),
                    ThemeSettingsUpdate.StringValue(
                        ThemeStringSetting.BookInfoDefaultCoverBackground,
                        defaultTheme.bookInfoDefaultCoverBackground
                    ),
                    ThemeSettingsUpdate.StringValue(ThemeStringSetting.BackgroundImageLight, null),
                    ThemeSettingsUpdate.StringValue(ThemeStringSetting.BackgroundImageDark, null),
                    ThemeSettingsUpdate.StringValue(
                        ThemeStringSetting.EyeProtectionStartTime,
                        defaultTheme.eyeProtectionStartTime
                    ),
                    ThemeSettingsUpdate.StringValue(
                        ThemeStringSetting.EyeProtectionEndTime,
                        defaultTheme.eyeProtectionEndTime
                    ),
                    ThemeSettingsUpdate.StringValue(ThemeStringSetting.CustomTagColorsJson, null),
                )
            )
