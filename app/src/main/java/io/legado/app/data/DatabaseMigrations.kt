...
object DatabaseMigrations {
    ...
    private val migration_10_11 = object : Migration(10, 11) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("DROP TABLE txtTocRules")
            connection.execSQL(
    ...
    private val migration_11_12 = object : Migration(11, 12) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE rssSources ADD style TEXT ")
        }
    }

    private val migration_12_13 = object : Migration(12, 13) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE rssSources ADD articleStyle INTEGER NOT NULL DEFAULT 0 ")
        }
    }
    ...
    private val migration_13_14 = object : Migration(13, 14) {
        override fun migrate(connection: SQLiteConnection) {
            ...
            connection.execSQL("INSERT INTO books_new select * from books ")
    ...
    private val migration_14_15 = object : Migration(14, 15) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE bookmarks ADD bookAuthor TEXT NOT NULL DEFAULT ''")
        }
    }

    private val migration_15_17 = object : Migration(15, 17) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("CREATE TABLE IF NOT EXISTS `readRecord` (`bookName` TEXT NOT NULL, `readTime` INTEGER NOT NULL, PRIMARY KEY(`bookName`))")
        }
    }

    private val migration_17_18 = object : Migration(17, 18) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("CREATE TABLE IF NOT EXISTS `httpTTS` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `url` TEXT NOT NULL, PRIMARY KEY(`id`))")
        }
    }
    ...
    private val migration_18_19 = object : Migration(18, 19) {
        override fun migrate(connection: SQLiteConnection) {
            ...
            connection.execSQL("INSERT INTO readRecordNew(androidId, bookName, readTime) select '${AppConst.androidId}' as androidId, bookName, readTime from readRecord")
    ...
    private val migration_19_20 = object : Migration(19, 20) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE book_sources ADD bookSourceComment TEXT")
        }
    }

    private val migration_20_21 = object : Migration(20, 21) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE book_groups ADD show INTEGER NOT NULL DEFAULT 1")
        }
    }
    ...
    private val migration_22_23 = object : Migration(22, 23) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE chapters ADD baseUrl TEXT NOT NULL DEFAULT ''")
        }
    }
    ...
    private val migration_25_26 = object : Migration(25, 26) {
        override fun migrate(connection: SQLiteConnection) {
            ...
            connection.execSQL(" insert into `ruleSubs` select *, 0, 0 from `sourceSubs` ")
            connection.execSQL("DROP TABLE `sourceSubs`")
        }
    }

    private val migration_26_27 = object : Migration(26, 27) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL(" ALTER TABLE rssSources ADD singleUrl INTEGER NOT NULL DEFAULT 0 ")
            connection.execSQL(
            ...
            connection.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_bookmarks_time` ON `bookmarks` (`time`)")
        }
    }

    private val migration_27_28 = object : Migration(27, 28) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE rssArticles ADD variable TEXT")
            connection.execSQL("ALTER TABLE rssStars ADD variable TEXT")
        }
    }

    private val migration_28_29 = object : Migration(28, 29) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE rssSources ADD sourceComment TEXT")
        }
    }

    private val migration_29_30 = object : Migration(29, 30) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE chapters ADD `startFragmentId` TEXT")
            connection.execSQL("ALTER TABLE chapters ADD `endFragmentId` TEXT")
            connection.execSQL(
                """
            ...
            connection.execSQL("CREATE INDEX IF NOT EXISTS `index_epubChapters_bookUrl` ON `epubChapters` (`bookUrl`)")
            connection.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_epubChapters_bookUrl_href` ON `epubChapters` (`bookUrl`, `href`)")
        }
    }

    private val migration_30_31 = object : Migration(30, 31) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE readRecord RENAME TO readRecord1")
            connection.execSQL(
                """
            ...
            connection.execSQL("insert into readRecord (deviceId, bookName, readTime) select androidId, bookName, readTime from readRecord1")
        }
    }

    private val migration_31_32 = object : Migration(31, 32) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("DROP TABLE `epubChapters`")
        }
    }

    private val migration_32_33 = object : Migration(32, 33) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE bookmarks RENAME TO bookmarks_old")
            connection.execSQL(
                """
    ...
    private val migration_33_34 = object : Migration(33, 34) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `book_groups` ADD `cover` TEXT")
        }
    }

    private val migration_34_35 = object : Migration(34, 35) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `book_sources` ADD `concurrentRate` TEXT")
        }
    }

    private val migration_35_36 = object : Migration(35, 36) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `book_sources` ADD `loginUi` TEXT")
            connection.execSQL("ALTER TABLE `book_sources` ADD`loginCheckJs` TEXT")
        }
    }

    private val migration_36_37 = object : Migration(36, 37) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `rssSources` ADD `loginUrl` TEXT")
            connection.execSQL("ALTER TABLE `rssSources` ADD `loginUi` TEXT")
            connection.execSQL("ALTER TABLE `rssSources` ADD `loginCheckJs` TEXT")
        }
    }

    private val migration_37_38 = object : Migration(37, 38) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `book_sources` ADD `respondTime` INTEGER NOT NULL DEFAULT 180000")
        }
    }

    private val migration_38_39 = object : Migration(38, 39) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `rssSources` ADD `concurrentRate` TEXT")
        }
    }

    private val migration_39_40 = object : Migration(39, 40) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `chapters` ADD `isVip` INTEGER NOT NULL DEFAULT 0")
            connection.execSQL("ALTER TABLE `chapters` ADD `isPay` INTEGER NOT NULL DEFAULT 0")
        }
    }

    private val migration_40_41 = object : Migration(40, 41) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `httpTTS` ADD `loginUrl` TEXT")
            connection.execSQL("ALTER TABLE `httpTTS` ADD `loginUi` TEXT")
            connection.execSQL("ALTER TABLE `httpTTS` ADD `loginCheckJs` TEXT")
            connection.execSQL("ALTER TABLE `httpTTS` ADD `header` TEXT")
            connection.execSQL("ALTER TABLE `httpTTS` ADD `concurrentRate` TEXT")
        }
    }

    private val migration_41_42 = object : Migration(41, 42) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE 'httpTTS' ADD `contentType` TEXT")
        }
    }

    private val migration_42_43 = object : Migration(42, 43) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE `chapters` ADD `isVolume` INTEGER NOT NULL DEFAULT 0")
        }
    }

    private val migration_82_83 = object : Migration(82, 83) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE readRecord RENAME TO readRecord_old")
            connection.execSQL(
                """
            ...
            connection.execSQL("DROP TABLE readRecord_old")

            connection.execSQL("ALTER TABLE readRecordDetail RENAME TO readRecordDetail_old")
            connection.execSQL(
                """
            ...
            connection.execSQL("DROP TABLE readRecordDetail_old")

            connection.execSQL("ALTER TABLE readRecordSession RENAME TO readRecordSession_old")
            connection.execSQL(
                """
            ...
            connection.execSQL("DROP TABLE readRecordSession_old")
        }
    }
    ...
    private val migration_98_99 = object : Migration(98, 99) {
        override fun migrate(connection: SQLiteConnection) {
            ...
            connection.execSQL("DROP TABLE txtTocRules")
            connection.execSQL("ALTER TABLE txtTocRules_new RENAME TO txtTocRules")
            connection.execSQL("ALTER TABLE highlightRules ADD COLUMN fontWeight INTEGER NOT NULL DEFAULT 400")
            connection.execSQL("ALTER TABLE highlightRules ADD COLUMN isItalic INTEGER NOT NULL DEFAULT 0")
            connection.execSQL("ALTER TABLE highlightRules ADD COLUMN npLeft REAL NOT NULL DEFAULT 0.1")
            connection.execSQL("ALTER TABLE highlightRules ADD COLUMN npRight REAL NOT NULL DEFAULT 0.1")
            connection.execSQL("ALTER TABLE highlightRules ADD COLUMN npTop REAL NOT NULL DEFAULT 0.1")
            connection.execSQL("ALTER TABLE highlightRules ADD COLUMN npBottom REAL NOT NULL DEFAULT 0.1")
        }
    }

    private val migration_99_100 = object : Migration(99, 100) {
        override fun migrate(connection: SQLiteConnection) {
            connection.execSQL("ALTER TABLE highlightRules ADD COLUMN fontSizeOffset INTEGER NOT NULL DEFAULT 0")
        }
    }
    ...
    private val migration_102_103 = object : Migration(102, 103) {
        override fun migrate(connection: SQLiteConnection) {
            ...
            connection.execSQL("DROP TABLE readRecord")
            connection.execSQL("ALTER TABLE readRecord_migrated RENAME TO readRecord")
            ...
            connection.execSQL("DROP TABLE readRecordDetail")
            connection.execSQL("ALTER TABLE readRecordDetail_migrated RENAME TO readRecordDetail")
            ...
            connection.execSQL("DROP TABLE readRecordSession")
            connection.execSQL("ALTER TABLE readRecordSession_migrated RENAME TO readRecordSession")
        }
    }
}
