...
object PreferKey {
    ...
    const val cTopBarColor = "colorTopBar"
    const val cNavBarColor = "colorNavBar"
    const val cFontColor = "colorFont"
    const val cBgColor = "colorThemeBackground"
    const val enableDeepPersonalization = "enableDeepPersonalization"
    // Material Design 3 color roles
    const val cMD3Primary = "colorMD3Primary"
    const val cMD3OnPrimary = "colorMD3OnPrimary"
    const val cMD3PrimaryContainer = "colorMD3PrimaryContainer"
    const val cMD3OnPrimaryContainer = "colorMD3OnPrimaryContainer"
    ...
    const val cMD3OnSurface = "colorMD3OnSurface"
    const val cMD3Background = "colorMD3Background"
    const val cMD3Outline = "colorOutline"
    const val cMD3SurfaceContainerLow = "colorMD3SurfaceContainerLow"
    const val cMD3SurfaceVariant = "colorMD3SurfaceVariant"
