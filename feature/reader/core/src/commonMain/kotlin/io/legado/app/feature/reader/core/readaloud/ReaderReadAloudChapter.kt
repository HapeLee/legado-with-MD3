...
/** Platform-neutral speech input derived from the reader's semantic chapter text. */
data class ReaderSpeechParagraph(
    val index: Int,
    val text: String,
    val chapterPosition: Int,
)
...
data class ReaderReadAloudChapter(
    ...
    fun speechParagraphs(): List<ReaderSpeechParagraph> = paragraphs.mapIndexed {
        index, paragraph ->
        ReaderSpeechParagraph(index, paragraph.text.sanitizeForSpeech(), paragraph.chapterPosition)
    }
