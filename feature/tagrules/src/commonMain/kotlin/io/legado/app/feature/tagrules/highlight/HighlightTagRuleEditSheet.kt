...
import io.legado.app.feature.tagrules.res.action_save
...
import io.legado.app.feature.tagrules.res.highlight_tag_add_rule
import io.legado.app.feature.tagrules.res.highlight_tag_edit_rule
import io.legado.app.feature.tagrules.res.highlight_tag_pattern
import io.legado.app.feature.tagrules.res.highlight_tag_title
import io.legado.app.feature.tagrules.res.more_menu
import io.legado.app.feature.tagrules.res.paste_rule
...
fun HighlightTagRuleEditSheet(
    ...
    AppModalBottomSheet(
        title = if (isNew) {
            stringResource(Res.string.highlight_tag_add_rule)
        } else {
            stringResource(Res.string.highlight_tag_edit_rule)
        },
        startAction = {
            MediumTonalButton(
        ...
        Box(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                AppTextField(
                    ...
                    label = stringResource(Res.string.highlight_tag_title),
                    singleLine = true
                )
                AppTextField(
                    modifier = Modifier.fillMaxWidth(),
                    ...
                    backgroundColor = LegadoTheme.colorScheme.surface,
                    label = stringResource(Res.string.highlight_tag_pattern),
                    minLines = 3
                )
