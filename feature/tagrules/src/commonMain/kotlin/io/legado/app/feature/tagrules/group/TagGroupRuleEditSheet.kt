...
import io.legado.app.feature.tagrules.res.tag_group_add_rule
import io.legado.app.feature.tagrules.res.tag_group_edit_rule
import io.legado.app.feature.tagrules.res.tag_group_name
import io.legado.app.feature.tagrules.res.tag_group_pattern
...
fun TagGroupRuleEditSheet(
    ...
    AppModalBottomSheet(
        title = if (isNew) {
            stringResource(Res.string.tag_group_add_rule)
        } else {
            stringResource(Res.string.tag_group_edit_rule)
        },
        startAction = {
            MediumTonalButton(
        ...
        Box(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                AppTextField(
                    ...
                    label = stringResource(Res.string.tag_group_name),
                    singleLine = true
                )
                AppTextField(
                    modifier = Modifier.fillMaxWidth(),
                    ...
                    backgroundColor = LegadoTheme.colorScheme.surface,
                    label = stringResource(Res.string.tag_group_pattern),
                    minLines = 3
                )
