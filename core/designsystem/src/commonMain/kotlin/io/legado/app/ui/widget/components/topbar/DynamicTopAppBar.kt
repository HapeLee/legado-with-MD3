...
import io.legado.app.core.designsystem.res.cancel_select
import io.legado.app.core.designsystem.res.list_loading_title
import io.legado.app.core.designsystem.res.list_selected_count
import io.legado.app.core.designsystem.res.more_menu
import io.legado.app.core.designsystem.res.search
...
fun <T> DynamicTopAppBar(
    ...
    GlassMediumFlexibleTopAppBar(
        modifier = Modifier
            .fillMaxWidth(),
        title = when {
            state.isLoading -> stringResource(Res.string.list_loading_title)
            isSelecting -> stringResource(
                Res.string.list_selected_count,
            ...
            if (isSelecting || onBackClick != null) {
                TopBarNavigationButton(
                    ...
                    contentDescription = stringResource(
                        if (isSelecting) Res.string.cancel_select else Res.string.back
                    )
                )
            }
        },
