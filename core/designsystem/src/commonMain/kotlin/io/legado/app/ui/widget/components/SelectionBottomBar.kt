...
import io.legado.app.core.designsystem.res.invert_selection
...
fun SelectionBottomBar(
    ...
    val selectAllDescription = stringResource(Res.string.select_all)
    val invertSelectionDescription = stringResource(Res.string.invert_selection)
    val moreActionsDescription = stringResource(Res.string.more_menu)
