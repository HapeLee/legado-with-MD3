...
import io.legado.app.ui.platform.systemGestureExclusionCompat
            ...
            Box(
                modifier = Modifier
                    ...
                    .then(
                        ...
                        // M1-3v：经 `ui.platform.systemGestureExclusionCompat()`——Android 转发原生，非 Android 恒等。
                        if (thumbDraggable && !isThumbDragged) {
                            Modifier.systemGestureExclusionCompat()
                        } else {
                            Modifier
                        },
                    )
